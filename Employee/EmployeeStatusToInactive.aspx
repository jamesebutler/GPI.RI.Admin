<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeeStatusToInactive.aspx.cs" Inherits="GPI.RI.Admin.Employee.EmployeeStatusToInactive" %>
...
<%--        <telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server" Visible="false">
    ...
    <%-- <div class="container-fluid">--%>
                ...
                <div class="row"> 
                <div class="col-lg-12">
                    <h3><asp:Label ID="LabelSetStatus" runat="server" Text="Set Employee to InActive" ></asp:Label></h3>
                </div>
        </div>
        ...
        <div class="col-lg-12" >
                ...
                <strong>
                Select the Employee to update the status to inactive.<br />
                If the employee has any open tasks, assign tasks to another Mill employee.  <br />
                Click "Update to Inactive" 
                </strong>
                </p>
        </div>
        </div>
...
<%--                <div class="row row-no-gutters" style="background-color:#367CCF;color:white" >
        ...
        <div class="row row-no-gutters"> 
                        ...
                        <div class="col-lg-3">
                            <asp:Label ID="LabelEmployee" runat="server" Font-Bold="true" >Active Employee:</asp:Label>
                        </div>
        ...
        <div class="row row-no-gutters"> 
                        ...
                        <div class="col-lg-3">
                         ...
                         <div class="col-lg-2" >
                             <telerik:RadButton ID="ButtonUpdate" Enabled="false" OnClick="ButtonUpdate_Click" Skin="Black" runat="server"  Text="Update to Inactive">
